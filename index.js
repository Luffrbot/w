...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=558694292223 :+55 86 9429 2223\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '🧃𝙀𝙎𝙏𝙊𝙐 𝙁𝘼𝙕𝙀𝙉𝘿𝙊!!! 𝙎𝙀 𝘿𝙀𝙍 𝙀𝙍𝙍𝙊 𝙏𝙀𝙉𝙏𝙀 𝙉𝙊𝙑𝘼𝙈𝙀𝙉𝙏𝙀 ',
				success: '✔️ Sucesso ✔️',
				...
				error: {
					stick: '[❗] 🥀𝙀𝙍𝙍𝙊!! 𝙏𝙀𝙉𝙏𝙀 𝙉𝙊𝙑𝘼𝙈𝙀𝙉𝙏𝙀!! 𝙎𝙀 𝘾𝙊𝙉𝙏𝙄𝙉𝙐𝘼 𝘿𝘼𝙉𝙊 𝙄𝙉𝙁𝙊𝙍𝙈𝙀 𝙊 𝘾𝙍𝙄𝘼𝘿𝙊𝙍! ❌',
					Iv: '❌ Link inválido ❌'
				},
				only: {
					group: '[❗] Este comando só pode ser usado em grupos! ❌',
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário! ❌',
					ownerB: '[❗] Este comando só pode ser usado pelo Kratos! ❌',
					admin: '[❗] Este comando só pode ser usado por administradores de grupo! ❌',
					Badmin: '[❗] Este comando só pode ser usado quando o bot se torna administrador! ❌',
                                        daftarB: `── 「REGISTRE-SE」 ──\nOlá como!\nVocê não está registrado no banco de dados, \n\nComando : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar Kratos|12`,
				}
			}
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '558694292223@s.whatsapp.net'
                        /******ApiKey Input******/
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
			...
			case 'quotes':
              ...
              case 'owner':
               ...
               client.sendMessage(from, '𝘾𝙊𝙉𝙏𝘼𝙏𝙊 𝘿𝙊 𝙈𝙀𝙐 𝘿𝙊𝙉𝙊 𝘼𝙇𝙀𝙆🥀 𝙆𝙍𝘼𝙏𝙊𝙎 𝘿𝙊𝙎 𝘽𝙊𝙏 𝙆𝙆',MessageType.text, { quoted: mek} )
                break
	case 'hidetag':
                client.updatePresence(from, Presence.composing) 
                if (!isUser) return reply(mess.only.daftarB)
              ...
              await client.sendMessage(from, options, text)
               break
				...
				case 'marvellogo':
					...
					if (args.length < 1) return reply(`Enviar pedidos ${prefix}marvellogo texto, por exemplo ${prefix}marvellogo 𝙈𝙄𝘿𝙊𝙍𝙄𝙔𝘼 𝘽𝙊𝙏`)
                                        if (!isUser) return reply(mess.only.daftarB)
					reply(mess.wait)
	...
	case 'kbbi':
		...
		if (args.length < 1) return reply ('*PARCEIROS*: \nEaxy: https://youtube.com/c/EAXYFF\nYamii: https://youtube.com/c/TioYamiiroivemsmpaki\nSaad: https://youtube.com/channel/UCtX3fzhC-teLUpaS7Xz8nKA\nKazuma: https://youtube.com/channel/UChRgBlar0IKGAsseuBeNRgA')
			    ...
			    case 'antiracismo':
					...
					if ((args[0]) === 'on') {
						if (isAntiRacismo) return reply('𝙊 𝙈𝙊𝘿𝙊 𝘼𝙉𝙏𝙄 𝙍𝘼𝘾𝙄𝙎𝙈𝙊 𝙀𝙎𝙏𝘼 𝙊𝙉🤖')
				...
				case 'loli1':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝙃𝙈𝙈 𝙀𝙉𝙏 𝙌𝙐𝙀 𝙑𝙀𝙍 𝙇𝙊𝙇𝙄?🤣'})
					break
				case 'hentai':
					memein = await kagApi.memeindo()
				...
				client.updatePresence(from, Presence.composing) 
					...
					mentions('╔══✪〘 Mencionando Todos 〙✪══\n╠➥'+teks+'╚═〘 𝙈𝙄𝘿𝙊𝙍𝙄𝙔𝘼 𝘽𝙊𝙏 〙', members_id, true)
					break
                case 'tagall2':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
				...
				client.updatePresence(from, Presence.composing) 
					...
					client.sendMessage(from, '╔══✪〘 Mencionando Todos 〙✪══\n╠➥'+teks+'╚═〘 𝙈𝙄𝘿𝙊𝙍𝙄𝙔𝘼 𝘽𝙊𝙏 〙', text, {detectLinks: false, quoted: mek})
					break
                        case 'tagall4':
				client.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
